  ...
  return (
    <div className="flex flex-col h-full w-full items-center bg-[#f9fafb]">
      ...
      <span className='text-lg text-gray-400 font-normal'>Выберите 2 варианта ответа. За каждый неверный ответ снимаются баллы</span>
            ...
            <span className='text-2xl font-semibold'>Отметьте научные библиотеки из предложенного списка (где можно найти научные статьи):</span>
            ...
            <div className={`${styles.variantblock} ${nextpoint === false ? styles.check : ''} ${selectedFourth==true && !truepoint ? styles.checkVar : ''} ${truepoint ? styles.true : ''}`} onClick={() => {handleCheck('fourth'); setSelectedFourth(true)}}>elibrary.ru</div>
