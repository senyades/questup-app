...
function Test2page3() {
  ...
  return (
    <div className="flex flex-col h-full w-full items-center bg-[#f9fafb]">
      ...
      {fireworkstrue === true && <Firework diamonds={5} exp={50} page={4} text={"Ты прочитал презентацию"}/>}

      <div ><div ><iframe title="ОТ 2" frameborder="0" width="1200" height="675"  src="https://view.genially.com/637ccabd9e97e000175638db" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all"></iframe> </div> </div>
